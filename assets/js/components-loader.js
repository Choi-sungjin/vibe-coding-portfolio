...
(function () {
  ...
  var fallbackHeader = '<header class="site-header header-transition" id="siteHeader" role="banner"><a href="#" class="logo" aria-label="최성진 포트폴리오 홈">CSJ.</a><nav class="nav-desktop" aria-label="주 메뉴"><a href="#about" class="nav-link" data-nav="about">ABOUT</a><a href="#skills" class="nav-link" data-nav="skills">SKILLS</a><a href="#works" class="nav-link" data-nav="works">WORKS</a><a href="#contact" class="nav-link" data-nav="contact">CONTACT</a></nav><button type="button" class="btn-menu" id="btnMenu" aria-label="메뉴 열기">☰</button></header>';
  var fallbackFooter = '<footer class="site-footer" role="contentinfo"><div class="footer-logo">CSJ.</div><p class="footer-slogan">코드로 아이디어를 현실로 만드는 개발자, 최성진</p><nav class="footer-links" aria-label="소셜 링크"><a href="https://github.com" target="_blank" rel="noopener noreferrer" aria-label="GitHub">🐙</a><a href="#" aria-label="LinkedIn">💼</a><a href="#" aria-label="이메일">📧</a></nav><p class="footer-copy">© 2024 Choi Seongjin. Designed & Developed by 최성진.</p></footer>';
